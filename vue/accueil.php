<section class="py-5 text-center container bg">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">La Societe AutoHiro</h1>
        <p class="lead text-muted">L'auto-école AutoHiro à Paris et à Plougerscant en Bretagne propose ses formations Auto, Moto et AM (BSR) avec un seul but : la réussite et la sécurité de ses élèves.

		Chaque formation est dispensée par un enseignant diplômé, expérimenté et sérieux.

		Votre vie d'automobiliste commence par un apprentissage évalué au début afin d'estimer le nombre de leçons de conduite dont vous seriez susceptible d'avoir besoin.

		L'objectif principal de Maxi Permis est de dispenser une formation de qualité et sans surprise tout en mettant le permis à la portée du plus grand nombre.

		Ainsi, dans nos agences auto-école à Paris et a Plougerscant, les informations sont claires, un maximum de prestations sont incluses ou offertes dans les forfaits, garantissant un tarif compétitif, sans surcoûts donc sans mauvaises surprises. De plus, une garantie financière est incluse dans tous nos forfaits.</p>
      </div>
    </div>
  </section>
