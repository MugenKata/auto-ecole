...
var DAY_IDS = ['dim', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat'];
// Adding
...
var RAW_EN_LOCALE = {
    ...
    moreLinkText: 'plus',
    noEventsText: 'Rien à afficher',
};
function organizeRawLocales(explicitRawLocales) {
    var defaultCode = explicitRawLocales.length > 0 ? explicitRawLocales[0].code : 'fr';
...
function buildDateEnv(settings) {
    var locale = buildLocale(settings.locale || 'fr', organizeRawLocales([]).map); // TODO: don't hardcode 'en' everywhere
